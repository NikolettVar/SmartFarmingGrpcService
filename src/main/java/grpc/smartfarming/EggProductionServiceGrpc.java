...
public final class EggProductionServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.smartfarming.CalculateRequest,
      grpc.smartfarming.CalculateResponse> getFeedingCalculatorMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "feedingCalculator",
      requestType = grpc.smartfarming.CalculateRequest.class,
      responseType = grpc.smartfarming.CalculateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.smartfarming.CalculateRequest,
      grpc.smartfarming.CalculateResponse> getFeedingCalculatorMethod() {
    io.grpc.MethodDescriptor<grpc.smartfarming.CalculateRequest, grpc.smartfarming.CalculateResponse> getFeedingCalculatorMethod;
      ...
      synchronized (EggProductionServiceGrpc.class) {
        if ((getFeedingCalculatorMethod = EggProductionServiceGrpc.getFeedingCalculatorMethod) == null) {
          EggProductionServiceGrpc.getFeedingCalculatorMethod = getFeedingCalculatorMethod = 
              io.grpc.MethodDescriptor.<grpc.smartfarming.CalculateRequest, grpc.smartfarming.CalculateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "EggProductionService", "feedingCalculator"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.smartfarming.CalculateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.smartfarming.CalculateResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.smartfarming.DailyEggCount,
      grpc.smartfarming.WeeklyEggCount> getWeeklyTotalEggCountMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "weeklyTotalEggCount",
      requestType = grpc.smartfarming.DailyEggCount.class,
      responseType = grpc.smartfarming.WeeklyEggCount.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<grpc.smartfarming.DailyEggCount,
      grpc.smartfarming.WeeklyEggCount> getWeeklyTotalEggCountMethod() {
    io.grpc.MethodDescriptor<grpc.smartfarming.DailyEggCount, grpc.smartfarming.WeeklyEggCount> getWeeklyTotalEggCountMethod;
      ...
      synchronized (EggProductionServiceGrpc.class) {
        if ((getWeeklyTotalEggCountMethod = EggProductionServiceGrpc.getWeeklyTotalEggCountMethod) == null) {
          EggProductionServiceGrpc.getWeeklyTotalEggCountMethod = getWeeklyTotalEggCountMethod = 
              io.grpc.MethodDescriptor.<grpc.smartfarming.DailyEggCount, grpc.smartfarming.WeeklyEggCount>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "EggProductionService", "weeklyTotalEggCount"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.smartfarming.DailyEggCount.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.smartfarming.WeeklyEggCount.getDefaultInstance()))
  ...
  public static abstract class EggProductionServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void feedingCalculator(grpc.smartfarming.CalculateRequest request,
        io.grpc.stub.StreamObserver<grpc.smartfarming.CalculateResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<grpc.smartfarming.DailyEggCount> weeklyTotalEggCount(
        io.grpc.stub.StreamObserver<grpc.smartfarming.WeeklyEggCount> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpc.smartfarming.CalculateRequest,
                grpc.smartfarming.CalculateResponse>(
                  this, METHODID_FEEDING_CALCULATOR)))
          .addMethod(
            getWeeklyTotalEggCountMethod(),
            asyncClientStreamingCall(
              new MethodHandlers<
                grpc.smartfarming.DailyEggCount,
                grpc.smartfarming.WeeklyEggCount>(
  ...
  public static final class EggProductionServiceBlockingStub extends io.grpc.stub.AbstractStub<EggProductionServiceBlockingStub> {
     ...
     * </pre>
     */
    public grpc.smartfarming.CalculateResponse feedingCalculator(grpc.smartfarming.CalculateRequest request) {
  ...
  public static final class EggProductionServiceFutureStub extends io.grpc.stub.AbstractStub<EggProductionServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.smartfarming.CalculateResponse> feedingCalculator(
        grpc.smartfarming.CalculateRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_FEEDING_CALCULATOR:
          serviceImpl.feedingCalculator((grpc.smartfarming.CalculateRequest) request,
              (io.grpc.stub.StreamObserver<grpc.smartfarming.CalculateResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class EggProductionServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.smartfarming.EggProductionServiceImpl.getDescriptor();
    }
